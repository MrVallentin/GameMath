...
#	define _GM_STRINGIFY_TOKEN(str) _GM_MATH_STRINGIFY(str)
#	define GM_STRINGIFY_VERSION(major, minor, patch) _GM_MATH_STRINGIFY(major) "." _GM_MATH_STRINGIFY(minor) "." _GM_MATH_STRINGIFY(patch)
#endif
